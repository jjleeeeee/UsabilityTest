...
Observation: <화면에서 관찰된 내용을 페르소나의 관점에서 한국어로 기술>
...
예: "일단 상품 사진은 크게 잘 보이네. 가격은 ₩25,000인데 밑에 캐시 ₩250이라고 적힌 건 적립금인가? 
배송 정보는... 음, 찾기 힘든데? 아코디언 메뉴를 눌러봐야 하나?"`
      : `[각 화면을 거치며 느낀 감정과 관찰을 1인칭으로]
- Step 1: "오케이, 시작 화면이네. 뭘 해야 하지? 로그인 버튼이 보이긴 하는데..."
- Step 2: "어? 이 버튼 누르면 되는 건가? 좀 헷갈리는데..."
